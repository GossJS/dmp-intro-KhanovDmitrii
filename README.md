...
Изменение формальной грамматики C -> CC | (C) | e, где e - символ, обозначающий в нашем восприятии пустоту:
Вводим новое правило
C -> (D) | D -> DD | (D) | e
тем самым все наши действия, цепочки действий, будут заключены в одну пару скобок


Четвертое д/з:

Самонеприменимое:
1) Если самоприменимое - значит, что его нельзя применить к себе - это противоречие. 
2) Если оно самонеприменимое - значит оно не может применяться к себе - это противоречие.
